...
<body>
	...
	<form action="" method="post" enctype="multipart/form-data">
		...
		<table>
			<tr>
				<input type="hidden" name="gambar_lama" required value="<?php echo $gambar_mhs; ?>">
				<td>Gambar</td>
				<td>:</td>
				<td>
			...
			<tr>
				...
				<td></td>
				<td>
					<img src="assets/image/<?php echo $gambar_mhs; ?>" width="100" style="display: block;" class="img-preview">
				</td>
			</tr>
			<tr>
				<td>NIM</td>
